...
export default class Train{
    ...
    constructor() {
        ...
        let labels = Deeplearn.Array2D.ones([this.imageWidth * this.imageHeight, 4])
        // console.log(labels.dataSync())
        // Util.getImage("profile-22.jpg")
        Util.getImage("scarlett2.jpg")
            .then(buffer => {

                var imageTensor = Deeplearn.Array2D.new([this.imageWidth * this.imageHeight, 4], Util.getImageNorm(buffer, this.imageWidth, this.imageHeight))
